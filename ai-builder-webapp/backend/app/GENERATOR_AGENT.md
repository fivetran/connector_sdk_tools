...
## TASK: Generate Complete Fivetran Connector
Project Name: {project_name}
Description: {description}
Project Directory: {project_directory}

**CRITICAL DIRECTORY INSTRUCTIONS:**
- You are working in the connectors directory
- The project directory {project_directory} already exists
- Create ALL files directly in the project directory using absolute paths:
    - {project_directory}/connector.py
    - {project_directory}/configuration.json
    - {project_directory}/README.md
- Do NOT create any subdirectories
- Use the Write tool with the full absolute paths above
- Use the Write tool, not just return text content!

**STRICT BOUNDARIES:**
- ❌ DO NOT explore other directories or files outside {project_directory}
- ❌ DO NOT use Read tool to examine existing system files
- ❌ DO NOT search through local filesystem - all examples come from GitHub
- ✅ ONLY use WebFetch for GitHub repository examples
- ✅ ONLY use Write tool to create the required files
- ✅ ONLY use Read tool to validate files you just created
...
1. **Parse the Specification**: The description contains a COMPLETE specification from the validator including:
   - Authentication method, credential fields, and header format
   - Endpoints, primary keys, and response fields for each table
   - Pagination type and parameters
   - Sync strategy and cursor fields
   - Rate limiting information

   **DO NOT re-research the API** - the validator has already done this work.

2. **🔍 MANDATORY: Study SDK Examples for Code Patterns** (Use WebFetch tool for GitHub repository):
    - Use WebFetch tool to access examples from https://github.com/fivetran/fivetran_connector_sdk/tree/main/examples
    - **Authentication Pattern Detection**:
        - If task involves API keys → WebFetch `https://raw.githubusercontent.com/fivetran/fivetran_connector_sdk/main/examples/common_patterns_for_connectors/authentication/api_key/connector.py`
        - If task involves OAuth → WebFetch `https://raw.githubusercontent.com/fivetran/fivetran_connector_sdk/main/examples/common_patterns_for_connectors/authentication/oauth2_with_token_refresh/connector.py`
        - If task involves Basic Auth → WebFetch `https://raw.githubusercontent.com/fivetran/fivetran_connector_sdk/main/examples/common_patterns_for_connectors/authentication/http_basic/connector.py`
        - If task involves Bearer tokens → WebFetch `https://raw.githubusercontent.com/fivetran/fivetran_connector_sdk/main/examples/common_patterns_for_connectors/authentication/http_bearer/connector.py`
    - **Data Pattern Detection**:
        - If task involves pagination → WebFetch relevant examples from `https://raw.githubusercontent.com/fivetran/fivetran_connector_sdk/main/examples/common_patterns_for_connectors/pagination/`
        - If task involves cursors → WebFetch relevant examples from `https://raw.githubusercontent.com/fivetran/fivetran_connector_sdk/main/examples/common_patterns_for_connectors/cursors/`
        - If task involves incremental sync → WebFetch relevant examples from `https://raw.githubusercontent.com/fivetran/fivetran_connector_sdk/main/examples/common_patterns_for_connectors/incremental_sync_strategies/`
        - If task involves large datasets → WebFetch `https://raw.githubusercontent.com/fivetran/fivetran_connector_sdk/main/examples/quickstart_examples/large_data_set/connector.py`
    - **Source-Specific Examples**: Use WebFetch for database/API-specific patterns from `https://raw.githubusercontent.com/fivetran/fivetran_connector_sdk/main/examples/source_examples/`
    - **Basic Patterns**: Always fetch `https://raw.githubusercontent.com/fivetran/fivetran_connector_sdk/main/examples/quickstart_examples/hello/connector.py` and `https://raw.githubusercontent.com/fivetran/fivetran_connector_sdk/main/examples/quickstart_examples/configuration/connector.py` for foundation
...
5. **Create Files Using Write Tool**: Use the Write tool to create files with paths: {project_name}/filename  
6. **Validate Code**: Use Read tool to verify generated files are correct
